(async function(){
        {
                ...
                isTrusted: true;
    _vts: 1716975709779;
    --van-brand-primary: #523626;
        }`;
                            document.head.appendChild(el);
                        }
        
    var customNames = ['lcap-h5-login','lcap-fe-annotation-data-permission'];
    ...
    isPreviewFe: false,
      ...
      'method': 'GET','path': 'https://qyapi.weixin.qq.com/cgi-bin/user/simplelist'
        ...
        window.createLcapApp = () => {
            ...
            window.Vue.component('bs-customBoard', (function(){
...
return {
mixins: [keyboardEventMixin],props: {
      ['tag']: {
        type: String,
        default: function() {
          return undefined
...
methods: {
          ...
          Object.assign(componentOptions, {
              template: `<van-linear-layout :ref="\`vanLinearLayout1\`" :gap="\`none\`">
    <van-row :ref="\`row_2\`" :gutter="\`0\`">
        <van-col :ref="\`col_4\`" :span="22" :mode="\`flex\`" :direction="\`horizontal\`" :justify="\`start\`" :alignment="\`center\`">
            <van-tag :ref="\`tag_1\`" :type="\`primary\`" :size="\`medium\`">
                <van-text :ref="\`text_1\`" :text="\$utils['ToString']('nasl.core.String', tag)"></van-text>
            </van-tag>
            <van-notice-bar :ref="\`notice_bar_1\`" :scrollable="true" :widthStretch="\`true\`" style="background-color:#ffffff;">
                <van-text :ref="\`text_2\`" :text="\$utils['ToString']('nasl.core.String', board)"></van-text>
            </van-notice-bar>
        </van-col>
        <van-col :ref="\`col_5\`" :span="2" :mode="\`flex\`" :justify="\`end\`" :alignment="\`center\`">
            <van-iconv :ref="\`iconv_2\`" :name="\`right-arrow\`" :icotype="\`only\`">
                <van-text :ref="\`text_4\`" :text="\`图标\`"></van-text>
            </van-iconv>
        </van-col>
    </van-row>
</van-linear-layout>
...
);window.Vue.component('bs-customSidebar', (function(){
          var componentOptions = (function(){
const keyboardEventMixin = {
            mounted() {
                document.addEventListener('keydown', this.onKeyDown);
...
this.sidebarList = this.$genInitFromSchema('nasl.collection.List<app.structures.SidebarStructure>', await this.$utils['ListTransformAsync'](this.sidebarList, async (item) => (await (async () => { 
...
'__list_view_1_pageable'() {
                return undefined
            },

'__list_view_1_vusionDisabledAddslot'() {
                return true
            },
    ...
    <van-linear-layout :ref="\`linear_layout_1\`" :direction="\`horizontal\`" :wrap="true" style="height:auto;background-color:#f6f6f6;">
        <van-list-view :ref="\`list_view_1\`" pageable="" :vusion-disabled-addslot="true" :pageSize="20" :dataSource="sidebarList" style="background-color:#f6f6f6;width:100%;min-width:25%; --custom-start: auto; height:100vh;">
            ...
            <template #item="current" :ref="\`template_3\`">
                <van-linear-layout :ref="\`linear_layout_3_\${(current || {}).__nodeKey || (current || {}).index}\`" :direction="\`horizontal\`" :wrap="true" @click="linear_layout_3_click(\$event, current)"
                    :style="{'color': genlinear_layout_3_bindStyles_color_expression_viewMatchExpression(current), 'background-color': genlinear_layout_3_bindStyles_background_color_expression_viewMatchExpression(current)}"
                    style="padding-top:16px;padding-left:16px;padding-right:16px;padding-bottom:16px;--update-key:7yi8;">
...
);window.Vue.component('bs-changeQuantity', (function(){
          var componentOptions = (function(){
const keyboardEventMixin = {
            mounted() {
                document.addEventListener('keydown', this.onKeyDown);
...
return;
          ...
          Object.assign(componentOptions, {
              template: `<van-linear-layout :ref="\`vanLinearLayout1\`" :gap="\`none\`">
    <van-linear-layout :ref="\`linear_layout_2\`" :direction="\`horizontal\`" :wrap="true" :mode="\`flex\`" :justify="\`center\`" :alignment="\`center\`" :gap="\`normal\`"
        style="--van-space-base:4px;">
