(async function(){
        {
                ...
                isTrusted: true;
    _vts: 1716975667256;
    --brand-primary: #bc8148;
    --brand-primary-lightest: #f8f1eb;
    --brand-primary-lighter: #e9d5c2;
    --brand-primary-light: #c38f5c;
    --brand-primary-dark: #a9733e;
    --brand-primary-darker: #3f2b17;
    --brand-primary-darkest: #150e08;
    --brand-primary-disabled: #e9d5c2;
    --brand-primary-opacity-20: #bc814833;
        }`;
                            document.head.appendChild(el);
                        }
        
    var customNames = ['lcap-login','lcap-fe-annotation-data-permission'];
    ...
    appConfig: {
        ...
        project: 'coffee0528',
        domainName: 'coffee0528',
        nuimsDomain: 'user.codewave.163.com',
        lowcodeDomain: 'codewave.163.com',
        envNuimsDomain: {
            dev: 'user.codewave.163.com',
            online: 'user.codewave.163.com',
        },
        tenantType: 0,
        tenantLevel: 1,
        extendedConfig: null,
        envConfig: {
            lowcodeDomain: 'app.codewave.163.com',
        },
        tenant: 'jystudy',
        documentTitle: null,
        rootViewData: [
    ...
    dnsAddr: 'https://coffee0528-jystudy.app.codewave.163.com',
    tenant: 'jystudy',
    env: 'dev',
    hasUserCenter: true,
    hasAuth: true,
    authResourcePaths: [
        '/permissionCenter/departmentManagement',
        '/permissionCenter/roleManagement',
        '/permissionCenter/userManagement',
        '/permissionCenter/permissionManagement',
        '/permissionCenter',
    ],
    baseResourcePaths: [
        '/login',
        '/dashboard/orderManagement',
        '/dashboard/coffeeManagement',
        '/dashboard/coffeeCateGoryManagement',
        '/dashboard/slideManagement',
        '/dashboard',
        '/noAuth',
        '/notFound',
        '/index',
    ...
    isPreviewFe: false,
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410604,'composedBy': null
    },'nasl.core.Long': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    },'nasl.core.DateTime': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'DateTime'
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410598,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410592,'composedBy': null
    },'nasl.core.Boolean': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410588,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410583,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410578,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410572,'composedBy': null
    ...
    }],'applyAnnotations': null,'changedTime': 1717661410567,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': [],'changedTime': 1717661410563,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410558,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410553,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410548,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410540,'composedBy': null
    ...
    }],'indexes': [],'applyAnnotations': null,'changedTime': 1717661410531,'composedBy': null
      ...
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    },'required': true,'primaryKey': true,'display': {
      'inDetail': false,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'auto','sequence': 'Entity14638963982','defaultCode': {
      ...
      'inDetail': false,'inForm': false,'inTable': true,'inFilter': false
    },'rules': [],'generationRule': 'auto','defaultCode': {
      ...
      'concept': 'EntityProperty','name': 'orderId','uuid': '989300051a6246fc80844dd1a4092927','columnName': 'order_id','label': '订单id','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'relationNamespace': 'app.dataSources.defaultDS.entities','relationEntity': 'OrderEntity','relationProperty': 'id','display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882797918,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'coffeeId','uuid': '336d8589c75a40d38e959347ca86b929','columnName': 'coffee_id','label': '咖啡id','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'relationNamespace': 'app.dataSources.defaultDS.entities','relationEntity': 'Coffee','relationProperty': 'id','display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882803424,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'coffeeQuantity','uuid': '0299d55df5fa4bf0b3310821433c8847','columnName': 'coffee_quantity','label': '下单数量','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882787804,'defaultCode': {
      
    }
    }],'indexes': [],'changedTime': 1716882733139
      ...
      'inDetail': false,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'auto','sequence': 'Entity14606724129','defaultCode': {
      ...
      'inDetail': false,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'auto','changedTime': 1716882631750,'defaultCode': {
      ...
      'concept': 'EntityProperty','name': 'totalAmount','uuid': '8f027ab3f69249b1b9751b6904d663b7','columnName': 'total_amount','label': '订单总金额','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Decimal','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': {
      'scale': 2
    },'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': false,'inTable': true,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882685322,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'coffeeCount','uuid': 'ac9fa81b12414ae792d8a32b27b23338','columnName': 'coffee_count','label': '咖啡总数量','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': false,'inTable': true,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882684877,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'orderStatus','uuid': 'a96c600577af4f94be2604ee80846ae2','columnName': 'order_status','label': '订单状态','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.enums','typeName': 'OrderStatusEnum','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': false,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882684641,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'consigneeName','uuid': '07217826587344babff50cb681572954','columnName': 'consignee_name','label': '收货人姓名','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': false,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882634261,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'consigneePhone','uuid': 'baaed3318cc1470eba33cc4e90db3e38','columnName': 'consignee_phone','label': '收货人电话','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882649287,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'consigneeArea','uuid': 'cc3d57bd090b45d1bd1dc72b098ed9e4','columnName': 'consignee_area','label': '收货人地区','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882648676,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'consigneeAddress','uuid': '563ccedf1c214a0aa5c5e1c4de816b85','columnName': 'consignee_address','label': '收货人详细地址','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882648285,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'pickupMethod','uuid': 'a639f70902cf4b03bb7a7778ab7ada60','columnName': 'pickup_method','label': '取货方式','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.enums','typeName': 'PickupMethodEnum','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': false,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882690555,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'remark','uuid': 'a7f8bbff793740859c9ca8a030feeb03','columnName': 'remark','label': '备注','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'display': {
      'inDetail': true,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882681236,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'coffeeList','uuid': '44f99b16b415490abff005843eea4423','columnName': 'coffee_list','label': '咖啡信息','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'generic','typeNamespace': 'nasl.collection','typeName': 'List','typeArguments': [{
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.structures','typeName': 'CoffeeStructure','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': 'T','composedBy': null
    ...
    },'required': false,'display': {
      'inDetail': true,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882640290,'defaultCode': {
      
    }
    }],'indexes': [],'changedTime': 1716882112512
    },'nasl.core.Decimal': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Decimal','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': {
      'scale': 2
    },'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
      ...
      'concept': 'Structure','name': 'CoffeeStructure','description': '点单咖啡信息结构','properties': [{
      'concept': 'StructureProperty','name': 'coffee','label': '咖啡','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.dataSources.defaultDS.entities','typeName': 'Coffee'
    },'changedTime': 1716882477676,'defaultCode': {
      
    }
    },{
      'concept': 'StructureProperty','name': 'count','label': '数量','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    },'changedTime': 1716882490629,'defaultCode': {
      
    }
    }],'changedTime': 1717408013782
    },'app.dataSources.defaultDS.entities.Coffee': {
      'concept': 'Entity','name': 'Coffee','uuid': 'fbd20a8f4bfd4308983651d0096a8ae1','tableName': 'coffee','origin': 'ide','properties': [{
      ...
      'inDetail': false,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'auto','sequence': 'Entity18571242246','defaultCode': {
      ...
      'concept': 'EntityProperty','name': 'coffeename','uuid': '9b753ed896504d7c99ab21c8f8347abc','columnName': 'coffeename','label': '咖啡名称','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882062833,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'description','uuid': 'ea473efd35ed4ba891c0fb8062eca5f8','columnName': 'description','label': '咖啡简介','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882079638,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'price','uuid': 'b36e14e42990462da6adc76c4a2744d3','columnName': 'price','label': '价格','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Decimal','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': {
      'scale': 2
    },'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716882080264,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'coffeeImage','uuid': 'da2631df558e40988d8616e77dba8bb4','columnName': 'coffee_image','label': '咖啡图片','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
      ...
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': false
    },'rules': ['maxLength(4000)'],'generationRule': 'manual','changedTime': 1716882080953,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'coffeeCategory','uuid': 'e227a47624dd465682c7ee99bf0f1769','columnName': 'coffee_category','label': '咖啡类目','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'relationNamespace': 'app.dataSources.defaultDS.entities','relationEntity': 'CoffeeCategory','relationProperty': 'id','deleteRule': 'cascade','display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882064981,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'isDisplay','uuid': 'f0b8ad95ccf848fdad70cf3751668ba3','columnName': 'is_display','label': '是否显示','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716882066212,'defaultCode': {
      
    }
    }],'indexes': [],'changedTime': 1716881909860
      ...
      'inDetail': false,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'auto','sequence': 'Entity15477563177','defaultCode': {
      ...
      'concept': 'EntityProperty','name': 'cateGoryName','uuid': 'c04fe022cde04f4db2ea1e5bc5f835cd','columnName': 'cate_gory_name','label': '类目名称','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'databaseTypeAnnotation': {
      'concept': 'DatabaseTypeAnnotation','typeName': 'varchar','arguments': {
      'length': 30
      ...
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': ['maxLength(30)'],'generationRule': 'manual','changedTime': 1716881892953,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'isDisplay','uuid': 'f81c5e9edf8a48b8817709abd14772ef','columnName': 'is_display','label': '是否显示','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
      ...
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716881893603,'defaultCode': {
      'code': 'false','executeCode': false
    }
    }],'indexes': [],'changedTime': 1716881810809
      ...
      'inDetail': false,'inForm': false,'inTable': false,'inFilter': false
    },'rules': [],'generationRule': 'auto','sequence': 'Entity10449539556','defaultCode': {
      ...
      'concept': 'EntityProperty','name': 'slideImage','uuid': '9c8d368c399d4616b8699cd2cbd6ad51','columnName': 'slide_image','label': '幻灯片图片','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'databaseTypeAnnotation': {
      'concept': 'DatabaseTypeAnnotation','typeName': 'varchar','arguments': {
      'length': 4000
      ...
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': false
    },'rules': ['maxLength(4000)'],'generationRule': 'manual','changedTime': 1716881758227,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'displayOrder','uuid': 'de8a71f10aa44cfb9ca7f91f2b3753f9','columnName': 'display_order','label': '显示顺序','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'display': {
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': false
    },'rules': [],'generationRule': 'manual','changedTime': 1716881758942,'defaultCode': {
      
    }
    },{
      'concept': 'EntityProperty','name': 'isDisplay','uuid': '4c7c724164bf41b29456fdccc148bdaa','columnName': 'is_display','label': '是否显示','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean','typeArguments': null,'returnType': null,'inferred': null,'properties': null,'ruleMap': null,'changedTime': null,'branchName': null,'workingCopy': null,'branch': null,'name': null,'composedBy': null
    },'required': true,'defaultValue': {
      'concept': 'DefaultValue','expression': {
      'concept': 'BooleanLiteral','value': 'false','folded': false
      ...
      'inDetail': true,'inForm': true,'inTable': true,'inFilter': true
    },'rules': [],'generationRule': 'manual','changedTime': 1716881747541,'defaultCode': {
      'code': 'false','executeCode': false
    }
    }],'indexes': [],'changedTime': 1716881672001
    ...
    }],'changedTime': 1717661410487
    },'app.structures.SidebarStructure': {
      'concept': 'Structure','name': 'SidebarStructure','description': '侧边栏','properties': [{
      'concept': 'StructureProperty','name': 'content','label': '内容','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    },'changedTime': 1717320066787,'defaultCode': {
      
    }
    },{
      'concept': 'StructureProperty','name': 'isSelect','label': '是否选中','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    },'defaultValue': {
      'concept': 'DefaultValue','expression': {
      'concept': 'BooleanLiteral','value': 'false','folded': false
    },'playground': [],'changedTime': 1717320090019
    },'changedTime': 1717320087326,'defaultCode': {
      'code': 'false','executeCode': false
    }
    },{
      'concept': 'StructureProperty','name': 'value','label': '值','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    },'changedTime': 1717320117502,'defaultCode': {
      
    }
    }],'changedTime': 1717316661160
    ...
    },'{altKey: nasl.core.Boolean, button: nasl.core.Long, clientX: nasl.core.Long, clientY: nasl.core.Long, ctrlKey: nasl.core.Boolean, metaKey: nasl.core.Boolean, movementX: nasl.core.Long, movementY: nasl.core.Long, offsetX: nasl.core.Long, offsetY: nasl.core.Long, pageX: nasl.core.Long, pageY: nasl.core.Long, screenX: nasl.core.Long, screenY: nasl.core.Long, which: nasl.core.Long}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'altKey','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    }
    },{
      'concept': 'StructureProperty','name': 'button','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'clientX','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'clientY','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'ctrlKey','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    }
    },{
      'concept': 'StructureProperty','name': 'metaKey','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    }
    },{
      'concept': 'StructureProperty','name': 'movementX','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'movementY','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'offsetX','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'offsetY','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'pageX','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'pageY','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'screenX','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'screenY','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'which','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    }]
    ...
    },'{node: {lCAPDepartment: app.dataSources.defaultDS.entities.LCAPDepartment}, oldNode: {lCAPDepartment: app.dataSources.defaultDS.entities.LCAPDepartment}, oldValue: nasl.core.String, value: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'node','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'lCAPDepartment','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.dataSources.defaultDS.entities','typeName': 'LCAPDepartment'
    }
      ...
      'concept': 'StructureProperty','name': 'oldNode','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'lCAPDepartment','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.dataSources.defaultDS.entities','typeName': 'LCAPDepartment'
    }
      ...
      'concept': 'StructureProperty','name': 'oldValue','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
    },{
      'concept': 'StructureProperty','name': 'value','typeAnnotation': {
    ...
    },'{index: nasl.core.Long, item: {lCAPRole: app.dataSources.defaultDS.entities.LCAPRole}, oldItem: {lCAPRole: app.dataSources.defaultDS.entities.LCAPRole}, oldValue: nasl.core.Long, selectedItem: {lCAPRole: app.dataSources.defaultDS.entities.LCAPRole}, value: nasl.core.Long}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'index','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
      ...
      'concept': 'StructureProperty','name': 'oldItem','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'lCAPRole','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.dataSources.defaultDS.entities','typeName': 'LCAPRole'
    }
      ...
      'concept': 'StructureProperty','name': 'selectedItem','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'lCAPRole','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.dataSources.defaultDS.entities','typeName': 'LCAPRole'
    }
    ...
    },'{item: nasl.core.String, items: nasl.collection.List<nasl.core.String>, oldItem: nasl.core.String, oldItems: nasl.collection.List<nasl.core.String>, oldValue: nasl.core.String, selected: nasl.core.Boolean, value: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'item','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
    },{
      'concept': 'StructureProperty','name': 'items','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'generic','typeNamespace': 'nasl.collection','typeName': 'List','typeArguments': [{
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }]
    }
      ...
      'concept': 'StructureProperty','name': 'oldItems','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'generic','typeNamespace': 'nasl.collection','typeName': 'List','typeArguments': [{
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }]
    }
      ...
      'concept': 'StructureProperty','name': 'selected','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    }
    },{
      'concept': 'StructureProperty','name': 'value','typeAnnotation': {
    ...
    },'{index: nasl.core.Long, item: app.structures.LCAPDataMetaStructure, oldItem: app.structures.LCAPDataMetaStructure, oldValue: nasl.core.Long, selectedItem: app.structures.LCAPDataMetaStructure, value: nasl.core.Long}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'index','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    ...
    },'{oldValue: nasl.core.String, value: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'oldValue','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
    ...
    },'{item: app.structures.LCAPDataMetaColunmRule, items: nasl.collection.List<app.structures.LCAPDataMetaColunmRule>, oldItem: app.structures.LCAPDataMetaColunmRule, oldItems: nasl.collection.List<app.structures.LCAPDataMetaColunmRule>, oldValue: nasl.core.String, selected: nasl.core.Boolean, value: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'item','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.structures','typeName': 'LCAPDataMetaColunmRule'
    }
    ...
    },'{item: app.structures.LCAPDataMetaColunmRule, items: nasl.collection.List<app.structures.LCAPDataMetaColunmRule>, oldItem: app.structures.LCAPDataMetaColunmRule, oldItems: nasl.collection.List<app.structures.LCAPDataMetaColunmRule>, oldValue: nasl.core.String, value: nasl.core.String, values: nasl.collection.List<nasl.core.String>}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'item','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.structures','typeName': 'LCAPDataMetaColunmRule'
    }
    ...
    },'{item: app.structures.LCAPComparisonResult, items: nasl.collection.List<app.structures.LCAPComparisonResult>, oldItem: app.structures.LCAPComparisonResult, oldItems: nasl.collection.List<app.structures.LCAPComparisonResult>, oldValue: nasl.core.String, selected: nasl.core.Boolean, value: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'item','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'app.structures','typeName': 'LCAPComparisonResult'
    }
    ...
    },'{item: nasl.core.String, items: nasl.collection.List<nasl.core.String>, oldItem: nasl.core.String, oldItems: nasl.collection.List<nasl.core.String>, oldValue: {}, selected: nasl.core.Boolean, value: {}}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'item','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
      ...
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': []
    },'{cancelBubble: nasl.core.Boolean, detail: nasl.core.String, layerX: nasl.core.Long, layerY: nasl.core.Long, pageX: nasl.core.Long, pageY: nasl.core.Long, which: nasl.core.Long}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'cancelBubble','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Boolean'
    }
    },{
      'concept': 'StructureProperty','name': 'detail','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
    },{
      'concept': 'StructureProperty','name': 'layerX','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'layerY','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'Long'
    }
    },{
      'concept': 'StructureProperty','name': 'pageX','typeAnnotation': {
    ...
    },'{date: nasl.core.String, time: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'date','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
    },{
      'concept': 'StructureProperty','name': 'time','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'primitive','typeNamespace': 'nasl.core','typeName': 'String'
    }
    }]
    },'{item: extensions.lcap_annotation_data_permission.structures.PropertyOption, items: nasl.collection.List<extensions.lcap_annotation_data_permission.structures.PropertyOption>, oldItem: extensions.lcap_annotation_data_permission.structures.PropertyOption, oldItems: nasl.collection.List<extensions.lcap_annotation_data_permission.structures.PropertyOption>, oldValue: nasl.core.String, selected: nasl.core.Boolean, value: nasl.core.String}': {
      'concept': 'TypeAnnotation','typeKind': 'anonymousStructure','properties': [{
      'concept': 'StructureProperty','name': 'item','typeAnnotation': {
      'concept': 'TypeAnnotation','typeKind': 'reference','typeNamespace': 'extensions.lcap_annotation_data_permission.structures','typeName': 'PropertyOption'
    }
      ...
      'method': 'GET','path': 'https://qyapi.weixin.qq.com/cgi-bin/user/simplelist'
        ...
        var routes = await importComponent('router.min.js?t=' + Date.now());
    ...
    .loading-container{
      ...
      const feAnnotation = {
        async handle(el, binding, vnode, oldVnode) {
          if(window.Vue.prototype.$library && window.Vue.prototype.$library['lcap-fe-annotation-data-permission']){
              window.Vue.prototype.$library['lcap-fe-annotation-data-permission'].feAnnotation(el, binding, vnode, oldVnode)
          }
        },
        bind(el, binding, vnode, oldVnode) {
            feAnnotation.handle(el, binding, vnode, oldVnode);
        },
        update(el, binding, vnode, oldVnode) {
            feAnnotation.handle(el, binding, vnode, oldVnode);
        },
      };
      window.Vue.directive('feAnnotation', feAnnotation);
