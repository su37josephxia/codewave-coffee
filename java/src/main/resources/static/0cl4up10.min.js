...
result = this.$genInitFromSchema('nasl.collection.List<app.structures.LCAPGetPerResult>', await (this.$logics['app.logics.LCAPLoadPerManagementTableView']({
                config: {
                    download: false,
                },
                query: {},
...
result = this.$genInitFromSchema('{list: nasl.collection.List<{lCAPPermission: app.dataSources.defaultDS.entities.LCAPPermission}>, total: nasl.core.Long}', await (this.$logics['app.logics.LCAPGetLAllACPPermission']({
                config: {
                    download: false,
                },
                query: {},
...
var $forEachListVariable3443 = (result || {}).list;
var $forEachStartVariable3443 = 0;
var $forEachEndVariable3443 = ((result || {}).list || {}).length;
if(Array.isArray($forEachListVariable3443)) {
for (let index = $forEachStartVariable3443; index < $forEachEndVariable3443; index++) {
const item = $forEachListVariable3443[index];
...
this.$genInitFromSchema('app.dataSources.defaultDS.entities.LCAPPermission', await (this.$logics['app.dataSources.defaultDS.entities.LCAPPermission.logics.update']({
                config: {
                    download: false,
                },
                query: {},
...
var $forEachListVariable768 = this.addResouces;
var $forEachStartVariable768 = 0;
var $forEachEndVariable768 = (this.addResouces || {}).length;
if(Array.isArray($forEachListVariable768)) {
for (let index = $forEachStartVariable768; index < $forEachEndVariable768; index++) {
const item = $forEachListVariable768[index];
...
this.$genInitFromSchema('nasl.collection.List<app.dataSources.defaultDS.entities.LCAPPerResMapping>', await (this.$logics['app.dataSources.defaultDS.entities.LCAPPerResMapping.logics.batchCreate']({
                config: {
                    download: false,
                },
                query: {},
...
this.$utils['ListDistinct'](this.permissionNameList)
if ((this.$genInitFromSchema('nasl.ui.ValidateResult', await (this.$refs && this.$refs[`saveModalForm`] && this.$refs[`saveModalForm`].validate && this.$refs[`saveModalForm`].validate())) || {}).valid) {
permissionCreated = this.$genInitFromSchema('app.dataSources.defaultDS.entities.LCAPPermission', await (this.$logics['app.dataSources.defaultDS.entities.LCAPPermission.logics.create']({
                config: {
                    download: false,
                },
                query: {},
...
if (((this.addResouces || {}).length) > (0)) {
var $forEachListVariable5389 = this.addResouces;
var $forEachStartVariable5389 = 0;
var $forEachEndVariable5389 = (this.addResouces || {}).length;
if(Array.isArray($forEachListVariable5389)) {
for (let index = $forEachStartVariable5389; index < $forEachEndVariable5389; index++) {
const item = $forEachListVariable5389[index];
...
this.notAddResouces = this.$genInitFromSchema('nasl.collection.List<app.structures.LCAPPermissionAndResource>', await (this.$logics['app.logics.LCAPGetPermissionResourseNotRelated']({
                config: {
                    download: false,
                },
                query: {},
...
this.addResouces = this.$genInitFromSchema('nasl.collection.List<app.structures.LCAPPermissionAndResource>', await (this.$logics['app.logics.LCAPGetPermissionResourceRelated']({
                config: {
                    download: false,
                },
                query: {},
...
this.permissionOldIdList = this.$genInitFromSchema('nasl.collection.List<nasl.core.Long>', await this.$utils['ListTransformAsync'](this.$genInitFromSchema('nasl.collection.List<{lCAPPerResMapping: app.dataSources.defaultDS.entities.LCAPPerResMapping}>', await (this.$logics['app.logics.LCAPGetPerResMappingByPermissionId']({
                config: {
                    download: false,
                },
                query: {},
...
'__tableView_showSizer'() {
  ...
  Object.assign(componentOptions, {
      template: `<l-root :ref="\`lRoot1\`" style="background-color:#F5F6FA; --custom-start: auto; height:calc(100vh - 210px);
min-height: 200px;">
    ...
    <u-linear-layout :ref="\`linear_layout_293\`" :direction="\`horizontal\`" style=" --custom-start: auto; height:calc(100vh - 210px);">
        <u-panel :ref="\`panel_1\`"
            style="margin-bottom:16px;--update-key:a59q;width:100%;border-top-width:0px;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;border-style:solid;">
        ...
        <u-panel :ref="\`panel_2\`"
            style="border-top-width:0px;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;border-style:solid;--update-key:lwdt;">
            <template #title :ref="\`template_73\`"></template>
            <u-table-view :ref="\`tableView\`" :dataSource="load" :dataSchema="\`LoadTest2TableViewStructure\`" :valueField="\`lACPPermission.id\`" :pagination="true"
                ...
                <u-table-view-column :ref="\`table_view_column3\`" :field="\`roleList\`">
                    <template #cell="current" :ref="\`template2\`">
                        <u-linear-layout :ref="\`linear_layout4_\${(current || {}).__nodeKey || (current || {}).index}\`" :gap="\`small\`">
                            <u-text :ref="\`text2_\${(current || {}).__nodeKey || (current || {}).index}\`"
                                :text="\$utils['ToString']('nasl.core.String', \$utils['Join'](\$utils['ListTransform'](((current || {}).item || {}).roleList, (item) => ((item || {}).name)), \`、\`))"></u-text>
                        </u-linear-layout>
                    </template>
                ...
                <u-table-view-column :ref="\`table_view_column7\`" :width="120">
                    <template #cell="current" :ref="\`template6\`">
                        <u-linear-layout :ref="\`linear_layout8_\${(current || {}).__nodeKey || (current || {}).index}\`" :gap="\`small\`">
                            <u-link :ref="\`link1_\${(current || {}).__nodeKey || (current || {}).index}\`" :text="\`修改\`"
                                :disabled="\$utils['Contains'](\$utils['ListTransform'](((current || {}).item || {}).roleList, (item) => ((item || {}).editable)), false)"
                                @click="link1_click(\$event, current)"></u-link>
                            <u-link :ref="\`link2_\${(current || {}).__nodeKey || (current || {}).index}\`" :text="\`删除\`"
                                :disabled="\$utils['Contains'](\$utils['ListTransform'](((current || {}).item || {}).roleList, (item) => ((item || {}).editable)), false)"
                                @click="link2_click(\$event, current)" style="--link-color:#F24957;--update-key:x3cb;"></u-link>
                        </u-linear-layout>
                    </template>
        ...
        <template #body :ref="\`template8\`">
            <u-form :ref="\`saveModalForm\`" key="saveModalForm">
                <u-form-item :ref="\`form_item6\`" :required="true"
                    :rules="[{validate: 'filled',message: \`权限名称不得为空\`,trigger: 'input+blur',required: true} , {validate: 'excluded',args: [permissionNameList] ,message: \`该权限名已存在\`,trigger: 'input+blur'}]">
                ...
                <u-form-item :ref="\`form_item_1\`" :labelLayout="\`block\`" style="--custom-start: auto;">
                    ...
                    <u-transfer :ref="\`transfer_1\`" :showHead="true" :sourceTitle="\`未选资源\`" :targetTitle="\`已选资源\`" :source.sync="notAddResouces" :target.sync="addResouces"
                        :filterable="true" :valueField="\`value\`" :textField="\`text\`" :clearable="true" style="--custom-start: auto;"></u-transfer>
                </u-form-item>
            </u-form>
        </template>
