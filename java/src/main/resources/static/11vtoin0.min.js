...
methods: {
  ...
  Object.assign(componentOptions, {
      template: `<u-linear-layout :ref="\`uLinearLayout1\`" :justify="\`center\`" :type="\`flex\`" :alignment="\`center\`" style="height: 100vh;">
    <u-linear-layout :ref="\`uLinearLayout2\`" :justify="\`center\`" :direction="\`vertical\`">
        ...
        <u-button :ref="\`uButton1\`" :text="\`返回首页\`" :color="\`primary\`" :link="\`\${\`/\`}\`" :shape="\`round\`"></u-button>
    </u-linear-layout>
</u-linear-layout>
`,
  });
