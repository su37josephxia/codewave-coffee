...
import com.jystudy.coffee0528.repository.entities.LCAPRolePerMappingMapper;
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPRolePerMapping", "lcap_role_per_mapping_f803ac", "id", "id"))
