...
import com.jystudy.coffee0528.repository.entities.CoffeeEntityMapper;
...
/**
* auto generate CoffeeEntityService ServiceImpl
*
* @author sys
*/
@Service
public class CoffeeEntityService extends AbstractService {
    @Resource
    private CoffeeEntityMapper mapper;
    @Resource
    ...
    public CoffeeEntityService() {
        ...
        entityFieldNameTitleMap.put("coffeename", "咖啡名称");
        entityFieldTitleNameMap.put("咖啡名称", "coffeename");
        entityFiledColumnNameMap.put("coffeename", "coffeename");
        entityFieldNameTitleMap.put("description", "咖啡简介");
        entityFieldTitleNameMap.put("咖啡简介", "description");
        entityFiledColumnNameMap.put("description", "description");
        entityFieldNameTitleMap.put("price", "价格");
        entityFieldTitleNameMap.put("价格", "price");
        entityFiledColumnNameMap.put("price", "price");
        entityFieldNameTitleMap.put("coffeeImage", "咖啡图片");
        entityFieldTitleNameMap.put("咖啡图片", "coffeeImage");
        entityFiledColumnNameMap.put("coffeeImage", "coffee_image");
        entityFieldNameTitleMap.put("coffeeCategory", "咖啡类目");
        entityFieldTitleNameMap.put("咖啡类目", "coffeeCategory");
        entityFiledColumnNameMap.put("coffeeCategory", "coffee_category");
    ...
    **/
    ...
    public CoffeeEntity create(CoffeeEntity entity) {
        if (null == entity) {
        ...
        entity.setCoffeename(getOrDefault(entity.getCoffeename(), ""));
        entity.setDescription(getOrDefault(entity.getDescription(), ""));
        entity.setPrice(getOrDefault(entity.getPrice(), BigDecimal.ZERO));
        entity.setCoffeeImage(getOrDefault(entity.getCoffeeImage(), ""));
        entity.setCoffeeCategory(getOrDefault(entity.getCoffeeCategory(), 0L));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<CoffeeEntity> batchCreate(List<CoffeeEntity> entities) {
        ...
        // fill default value
        List<CoffeeEntity> batchList = new ArrayList<>(100);
    ...
    **/
    @Transactional
    public CoffeeEntity update(CoffeeEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "CoffeeEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<CoffeeEntity> batchUpdate(List<CoffeeEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<CoffeeEntity> updateEntities = new ArrayList<>(entities.size());
        for (CoffeeEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        CoffeeEntity entity = mapper.selectOne( id ); 
    ...
    **/
     ...
     * auto gen get method
     **/
    public CoffeeEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<CoffeeEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<CoffeeEntity> data = ExcelUtil.read(file.getInputStream(), type, CoffeeEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<CoffeeEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, CoffeeEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + CoffeeEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public CoffeeEntity createOrUpdate(CoffeeEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, CoffeeEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            CoffeeEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(CoffeeEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
