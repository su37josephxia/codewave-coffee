...
import com.jystudy.coffee0528.repository.entities.CoffeeCategoryEntityMapper;
...
/**
* auto generate CoffeeCategoryEntityService ServiceImpl
*
* @author sys
*/
@Service
public class CoffeeCategoryEntityService extends AbstractService {
    @Resource
    private CoffeeCategoryEntityMapper mapper;
    @Resource
    ...
    public CoffeeCategoryEntityService() {
        ...
        entityFieldNameTitleMap.put("cateGoryName", "类目名称");
        entityFieldTitleNameMap.put("类目名称", "cateGoryName");
        entityFiledColumnNameMap.put("cateGoryName", "cate_gory_name");
    ...
    **/
    ...
    public CoffeeCategoryEntity create(CoffeeCategoryEntity entity) {
        if (null == entity) {
        ...
        entity.setCateGoryName(getOrDefault(entity.getCateGoryName(), ""));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<CoffeeCategoryEntity> batchCreate(List<CoffeeCategoryEntity> entities) {
        ...
        // fill default value
        List<CoffeeCategoryEntity> batchList = new ArrayList<>(100);
        for (CoffeeCategoryEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
    ...
    **/
    @Transactional
    public CoffeeCategoryEntity update(CoffeeCategoryEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "CoffeeCategoryEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<CoffeeCategoryEntity> batchUpdate(List<CoffeeCategoryEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<CoffeeCategoryEntity> updateEntities = new ArrayList<>(entities.size());
        for (CoffeeCategoryEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        CoffeeCategoryEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("CoffeeCategory", "coffee_category", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<CoffeeCategoryEntity>  entities = mapper.selectList(inQueryFilter);
        for (CoffeeCategoryEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public CoffeeCategoryEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<CoffeeCategoryEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<CoffeeCategoryEntity> data = ExcelUtil.read(file.getInputStream(), type, CoffeeCategoryEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<CoffeeCategoryEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, CoffeeCategoryEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + CoffeeCategoryEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public CoffeeCategoryEntity createOrUpdate(CoffeeCategoryEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, CoffeeCategoryEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            CoffeeCategoryEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(CoffeeCategoryEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
