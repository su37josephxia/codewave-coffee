...
import com.jystudy.coffee0528.util.SqlKeywordsUtils;
import com.jystudy.coffee0528.web.interceptor.annotation.SqlInjectionCheck;
...
public class SqlInjectionCheckAspect {
    ...
    @Pointcut(value = "@annotation(com.jystudy.coffee0528.web.interceptor.annotation.SqlInjectionCheck)")
