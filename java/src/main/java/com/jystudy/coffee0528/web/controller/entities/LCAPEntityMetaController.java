...
/**
* auto generate LCAPEntityMeta controller
*
* @author sys
*/
@RestController
public class LCAPEntityMetaController {
    @Resource
    private LCAPEntityMetaService service;

    /**
    * auto gen import method
    **/
    @PostMapping("/api/l-c-a-p-entity-meta/import")
