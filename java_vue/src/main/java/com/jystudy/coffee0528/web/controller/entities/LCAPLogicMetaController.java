...
/**
* auto generate LCAPLogicMeta controller
*
* @author sys
*/
@RestController
public class LCAPLogicMetaController {
    @Resource
    private LCAPLogicMetaService service;

    /**
    * auto gen import method
    **/
    @PostMapping("/api/l-c-a-p-logic-meta/import")
