...
/**
* auto generate CoffeeOrderMappingEntity controller
*
* @author sys
*/
@RestController
public class CoffeeOrderMappingEntityController {
    @Resource
    private CoffeeOrderMappingEntityService service;

    /**
    * auto gen import method
    **/
    @PostMapping("/api/coffee-order-mapping/import")
