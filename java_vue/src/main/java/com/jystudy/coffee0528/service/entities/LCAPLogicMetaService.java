...
import com.jystudy.coffee0528.repository.entities.LCAPLogicMetaMapper;
...
/**
* auto generate LCAPLogicMetaService ServiceImpl
*
* @author sys
*/
@Service
public class LCAPLogicMetaService extends AbstractService {
    @Resource
    private LCAPLogicMetaMapper mapper;
    @Resource
    ...
    public LCAPLogicMetaService() {
        ...
        entityFieldNameTitleMap.put("logicName", "逻辑名");
        entityFieldTitleNameMap.put("逻辑名", "logicName");
        entityFiledColumnNameMap.put("logicName", "logic_name");
        entityFieldNameTitleMap.put("returnShape", "逻辑返回值形式");
        entityFieldTitleNameMap.put("逻辑返回值形式", "returnShape");
        entityFiledColumnNameMap.put("returnShape", "return_shape");
        ...
        entityFieldNameTitleMap.put("logicDescription", "逻辑描述");
        entityFieldTitleNameMap.put("逻辑描述", "logicDescription");
        entityFiledColumnNameMap.put("logicDescription", "logic_description");
    }
    ...
    **/
    ...
    public LCAPLogicMeta create(LCAPLogicMeta entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<LCAPLogicMeta> batchCreate(List<LCAPLogicMeta> entities) {
        ...
        // fill default value
        List<LCAPLogicMeta> batchList = new ArrayList<>(100);
        for (LCAPLogicMeta entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
    ...
    **/
    @Transactional
    public LCAPLogicMeta update(LCAPLogicMeta entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "LCAPLogicMeta");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<LCAPLogicMeta> batchUpdate(List<LCAPLogicMeta> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<LCAPLogicMeta> updateEntities = new ArrayList<>(entities.size());
        for (LCAPLogicMeta entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        LCAPLogicMeta entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPLogicMeta", "lcap_logic_meta_f803ac", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<LCAPLogicMeta>  entities = mapper.selectList(inQueryFilter);
        for (LCAPLogicMeta entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public LCAPLogicMeta get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<LCAPLogicMeta> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<LCAPLogicMeta> data = ExcelUtil.read(file.getInputStream(), type, LCAPLogicMeta.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<LCAPLogicMeta> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, LCAPLogicMeta.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + LCAPLogicMeta.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public LCAPLogicMeta createOrUpdate(LCAPLogicMeta entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, LCAPLogicMeta.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            LCAPLogicMeta existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(LCAPLogicMeta entity, List<String> updateFields, AbstractQueryFilter filter) {
