...
CREATE TABLE `coffee_order_mapping` (
`id` bigint NOT NULL COMMENT '主键',
`created_time` datetime NULL COMMENT '创建时间',
`updated_time` datetime NULL COMMENT '更新时间',
`created_by` varchar(256) NULL COMMENT '创建者',
...
`coffee_id` bigint NULL COMMENT '咖啡id',
`coffee_quantity` bigint NULL COMMENT '下单数量',
PRIMARY KEY (`id`)
) COMMENT='咖啡订单中间表';
...
`created_by` varchar(256) NULL COMMENT '创建者',
`updated_by` varchar(256) NULL COMMENT '更新者',
`total_amount` decimal(31,2) NOT NULL COMMENT '订单总金额',
`coffee_count` bigint NOT NULL COMMENT '咖啡总数量',
`order_status` varchar(256) NOT NULL COMMENT '订单状态',
`consignee_name` varchar(256) NOT NULL COMMENT '收货人姓名',
`consignee_phone` varchar(256) NOT NULL COMMENT '收货人电话',
`consignee_area` varchar(256) NOT NULL COMMENT '收货人地区',
`consignee_address` varchar(256) NOT NULL COMMENT '收货人详细地址',
`pickup_method` varchar(256) NOT NULL COMMENT '取货方式',
`remark` varchar(256) NULL COMMENT '备注',
`coffee_list` text NULL COMMENT '咖啡信息',
PRIMARY KEY (`id`)
) COMMENT='订单信息';
...
`created_by` varchar(256) NULL COMMENT '创建者',
`updated_by` varchar(256) NULL COMMENT '更新者',
`coffeename` varchar(256) NOT NULL COMMENT '咖啡名称',
`description` varchar(256) NOT NULL COMMENT '咖啡简介',
`price` decimal(31,2) NOT NULL COMMENT '价格',
`coffee_image` varchar(4000) NOT NULL COMMENT '咖啡图片',
`coffee_category` bigint NOT NULL COMMENT '咖啡类目',
...
`created_by` varchar(256) NULL COMMENT '创建者',
`updated_by` varchar(256) NULL COMMENT '更新者',
`cate_gory_name` varchar(30) NOT NULL COMMENT '类目名称',
...
`created_by` varchar(256) NULL COMMENT '创建者',
`updated_by` varchar(256) NULL COMMENT '更新者',
`slide_image` varchar(4000) NOT NULL COMMENT '幻灯片图片',
`display_order` bigint NOT NULL COMMENT '显示顺序',
`is_display` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否显示',
PRIMARY KEY (`id`)
) COMMENT='幻灯片管理';
